    ...
    <div class="flex mt-4">
        <div class="w-7/12 rounded border p-2">
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-1" class="{{ $catalog ? 'block' : 'hidden' }}" aria-labelledby="accordion-collapse-heading-1">
                    @if ($catalog)
                        @foreach ($catalog->jobs as $item)
                            <div class="p-1 border border-b-0 border-gray-200 flex justify-left">
                                ...
                                <div>
                                    @livewire('buttons.copy-button', ['itemId' => $item->id], key($item->id))
                                </div>
                            </div>
                        @endforeach
                    @endif
                ...
                <h2 id="accordion-collapse-heading-2">
                    <button type="button"
                        class="flex items-center justify-between w-full p-3 font-medium rtl:text-right text-green-500  border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 hover:bg-green-50 dark:hover:bg-gray-800 gap-3"
