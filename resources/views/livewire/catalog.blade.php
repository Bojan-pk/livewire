<form  wire:submit="submitForm" class="w-10/12  flex justify-center">
        <div class="w-7/12 rounded border p-2">
            <h1 class=" text-xl font-medium mb-2">Каталог формацијских места</h1>
            <div>
            ...
            <input wire:model="form.fm" type="text" id="helper-text" aria-describedby="helper-text-explanation"
                ...
                <div>
                    @error('form.fm') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            ...
            <input wire:model="form.usualy_fms" type="text" id="helper-text"
                aria-describedby="helper-text-explanation"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Унестите називе формацијких места и одвојити их са ;">
                <div>
                    @error('form.usualy_fms') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            ...
            <textarea wire:model="form.educations" id="message" rows="1"
                ...
                <div>
                    @error('form.educations') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            ...
            <textarea wire:model="form.conditions" id="message" rows="2"
                ...
                <div>
                    @error('form.conditions') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

            <label for="helper-text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Радно искуство
                (опционо)</label>
            <input wire:model="form.experiences" type="text" id="helper-text"
                aria-describedby="helper-text-explanation"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Унеси потребно радно искуство">
                <div>
                    @error('form.experiences') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            ...
            <textarea id="message" wire:model="form.jobs" rows="4"
                ...
                placeholder="Унестите посебне услове и одвојити их са ;"></textarea>
                <div>
                    @error('form.jobs') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
        </div>
        <div class="w-5/12 mx-2 rounded border p-2">
            ...
            <label for="helper-text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Основ
                уноса</label>
            <input wire:model="form.regulation" type="text" id="helper-text" aria-describedby="helper-text-explanation"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Унеси документ на основу кога се врши унос">
                <div>
                    @error('form.regulation') <span class=" text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
            <button type="submit"
