                ...
                <div class="flex mb-2 space-x-2 rtl:space-x-reverse">
                    <div>
                        ...
                        <input type="text" maxlength="1" data-focus-input-init data-focus-input-next="code-2"
                            ...
                            class="block w-12 h-12 py-3 text-l font-extrabold text-center text-gray-900 bg-white border border-gray-400 rounded-lg focus:ring-primary-500 focus:border-primary-500"
                            required />
                    </div>
                    <div>
