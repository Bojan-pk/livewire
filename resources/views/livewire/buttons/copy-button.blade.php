<div>
    <button wire:click="copy"  class="text-gray-900 dark:text-gray-400 hover:bg-gray-100 rounded-lg py-1 px-1 inline-flex items-center bg-white border-gray-200 border ml-3">
        @if($copied)
