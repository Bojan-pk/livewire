    ...
    <form wire:submit="submitForm" class=" flex justify-center">
        <div class="w-9/12 rounded border p-2">
            ...
            <div class="relative overflow-x-auto">
                    ...
                    <tbody>
                        @if ($form->table_items)
                            @foreach ($form->table_items as $key => $value)
                                <tr wire:key="{{ $key }}" class="bg-white border-b hover:bg-gray-50 ">
                                    ...
                                    <td class="px-2 py-1">
                                        ...
                                        <button wire:click.prevent="confirmDelete({{ $key }})" type="button"
                                            class="text-red-400 hover:text-red-700 hover:underline">Бриши </button>
                                    </td>
                                </tr>
                            @endforeach
                            <div>
                ...
                <div class="text-left">
                    <a href="#" wire:click="addTableRow()" class=" text-blue-700 hover:underline  ">Додај</a>
                </div>
            </div>
        </div>
        <div class="w-3/12 mx-2 rounded border p-2">
            ...
            <div class="text-red-800" wire:dirty>Нису запамћене промене..</div> 
            ...
            <div class="relative w-full max-w-md mx-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <button wire:click.prevent="deleteRow"
